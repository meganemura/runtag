...
3. `npm pack --dry-run` and read the file list: `dist/`, `skills/`, `README.md`, `README.ja.md`, `CHANGELOG.md`, `LICENSE`, `llms.txt`, and `package.json`. That list omits `src/`, `test/`, and `docs/`.
